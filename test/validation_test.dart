  ...
  group('API Validation', () {
    group('ThrottlingConfig', () {
      ...
      test('windowDuration <= 0 throws ArgumentError', () {
        expect(
          () => ThrottlingConfig(windowDuration: Duration.zero),
          throwsArgumentError,
        );
        expect(
          () => ThrottlingConfig(windowDuration: Duration(seconds: -1)),
          throwsArgumentError,
        );
        expect(
          () => ThrottlingConfig.withCriticality(
    ...
    group('CircuitBreakerConfig', () {
      ...
      test('consecutiveFailuresThreshold < 1 throws ArgumentError', () {
        expect(
          () => CircuitBreakerConfig(consecutiveFailuresThreshold: 0),
          throwsArgumentError,
        );
        expect(
          () => CircuitBreakerConfig(consecutiveFailuresThreshold: -1),
          throwsArgumentError,
        );
      });
      ...
      test('resetTimeout <= 0 throws ArgumentError', () {
        expect(
          () => CircuitBreakerConfig(resetTimeout: Duration.zero),
          throwsArgumentError,
        );
        expect(
          () => CircuitBreakerConfig(resetTimeout: Duration(seconds: -1)),
          throwsArgumentError,
        );
      });
    });
    ...
    group('RetryConfig', () {
      ...
      test('baseDelay < 0 throws ArgumentError', () {
        expect(
          () => RetryConfig(baseDelay: Duration(seconds: -1)),
          throwsArgumentError,
        );
      });
      ...
      test('budgetWindow <= 0 throws ArgumentError', () {
        expect(
          () => RetryConfig(budgetWindow: Duration.zero),
          throwsArgumentError,
        );
      });
      ...
      test('minRequestsForBudget < 0 throws ArgumentError', () {
        expect(
          () => RetryConfig(minRequestsForBudget: -1),
          throwsArgumentError,
        );
      });
    });
    ...
    group('HedgingConfig', () {
      ...
      test('negative delays throw ArgumentError', () {
        expect(
          () => HedgingConfig(delay: Duration(seconds: -1)),
          throwsArgumentError,
        );
        expect(
          () => HedgingConfig(minDelay: Duration(seconds: -1)),
          throwsArgumentError,
        );
        expect(
          () => HedgingConfig(maxDelay: Duration(seconds: -1)),
          throwsArgumentError,
        );
      });
      ...
      test('dynamicPercentile not in [0.0, 1.0] throws ArgumentError', () {
        expect(
          () => HedgingConfig(dynamicPercentile: -0.1),
          throwsArgumentError,
        );
        expect(
          () => HedgingConfig(dynamicPercentile: 1.1),
          throwsArgumentError,
        );
      });
      ...
      test('maxOverloadTokens < 0 throws ArgumentError', () {
        expect(
          () => HedgingConfig(maxOverloadTokens: -0.1),
          throwsArgumentError,
        );
      });
      ...
      test('maxConcurrentHedges < 0 throws ArgumentError', () {
        expect(
          () => HedgingConfig(maxConcurrentHedges: -1),
          throwsArgumentError,
        );
      });
    });
    ...
    group('ResourceConfig', () {
      test('timeout <= 0 throws ArgumentError', () {
        expect(
          () => ResourceConfig(timeout: Duration.zero),
          throwsArgumentError,
        );
        expect(
          () => ResourceConfig(timeout: Duration(seconds: -1)),
          throwsArgumentError,
        );
      });
    });
